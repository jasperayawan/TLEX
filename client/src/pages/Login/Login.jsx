            ...
            <div className="w-1/2 h-screen flex justify-center items-center p-20">
                <div className="flex flex-col shadow-2xl w-full mx-auto max-w-lg px-4 py-4 rounded-md">
                    ...
                    <div className="flex flex-col gap-y-2 mb-4">
                        <h1 className="text-5xl font-bold text-[#59A52C] text-center">Login!</h1>
                    ...
                    <form>
                        <div className="flex flex-col gap-y-2">
                            ...
                            <div className="flex justify-end">
                                <Link to='/forget' className="text-gray-500 font-bold">Forget password?</Link>
                            </div>
                            <div className="flex flex-col gap-x-10 justify-start">
                            ...
                            <div className="flex justify-end">
                                <span>Don't have an account? <Link to='/register' className="text-[#59A52C]">Sign up now!</Link></span>
                            </div>
                            <div className="flex justify-center items-center mt-4">
                                <button 
                                    onClick={handleRegistration}
                                    className="px-10 py-2 rounded-md bg-[#59A52C]">Login</button>
                            </div>
                        </div>
                    </form>
                </div>
